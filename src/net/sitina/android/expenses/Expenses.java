...
public class Expenses extends ListActivity {
    ...
    private void fillData() {
        ...
        String[] from = new String[]{ExpensesDbAdapter.KEY_TITLE};
        ...
        SimpleCursorAdapter notes = 
        	    new SimpleCursorAdapter(this, R.layout.expenses_row, notesCursor, from, to);
    ...
    private void createNote() {
        Intent i = new Intent(this, ExpensesEdit.class);
